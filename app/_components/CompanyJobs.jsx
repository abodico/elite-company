                        ...
                        <SliderCard
                            text={
                                <p className="max-w-[75%] text-[22px] leading-6 font-semibold inter text-center">
                                    Providing comprehensive and advanced
                                    training courses in programming, design, and
                                    project management. It aims to enhance
                                    individuals' skills through interactive
                                    projects
                                </p>
                            }
                        />
